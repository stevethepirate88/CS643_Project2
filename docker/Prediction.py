...
model = CrossValidatorModel.load("./WineModel")


# Create the DataFrame
input_df = sqlContext.read.format('com.databricks.spark.csv').options(header='true', inferschema='true', sep=';').load("./ValidationDataset.csv")
