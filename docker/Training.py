...
trains3 = "s3a://cs643proj2/TrainingDataset.csv"
validates3 = "s3a://cs643proj2/ValidationDataset.csv"
train_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load(trains3)
validation_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load(validates3)
