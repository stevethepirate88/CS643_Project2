...
model = PipelineModel.load("s3a://cs643proj2/WineModel")

# Create the DataFrame
df = sqlContext.read.format('com.databricks.spark.csv').options(header='true', inferschema='true', sep=';').load('s3a://cs643proj2/ValidationDataset.csv')
